...
import {HistoryResultState, RootState} from "../../../redux/reducer";
...
class Timeline extends React.Component<TimelineProps&timelineStyle,{}>{
    ...
    render(){
        const { classes,timelineResult } = this.props;
        return(
            <div>
                ...
                <VerticalTimeline className={classes.timeline} layout="1-column">
                    {
                        timelineResult.result.map((r,index) =>{
                            ...
                            if(r.issueResult){
                                issueDescription=r.issueResult.description;
                                issueSummary=r.issueResult.summary;
                            }
                            const Issue=(
                                <div>
